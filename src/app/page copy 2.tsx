          ...
          {isSignedIn ? (
            <>
              <Button
                ...
                className="bg-[#fff] text-primary px-4 py-2 rounded-md shadow-md border border-primary hover:bg-primary/90 hover:text-[#fff] transition-colors duration-200"
              >
                Dashboard
              </Button>
            </>
            ...
            <>
              <SignInButton>
                <Button className="bg-[#fff] text-primary/100 px-4 py-2 rounded-md hover:bg-primary/100 hover:text-[#fff]">
                  Login
                </Button>
              </SignInButton>
      ...
      <footer className="w-full bg-emerald-950 text-white px-4 pt-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="font-bold text-lg">Chakam</span>
          </div>
